...
import com.cgj.model.Recommend;
...
public class GoodsDao {
    ...
    public Map<String, Object> getScrollGoods() throws SQLException {
        QueryRunner r =new QueryRunner(DBUtil.getDataSource());
        String sql="SELECT g.id,g.name,g.cover,g.price FROM recommend r,goods g where type = 2 and r.goods_id=g.id";
    ...
    public boolean isGood(Goods g) throws SQLException {
        return isRecommend(g,2);
    }

    public boolean isPratical(Goods g) throws SQLException {
